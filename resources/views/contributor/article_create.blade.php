    ...
    <div class="back-gray">
        <section class="container content-wrapper">
                    ...
                    <div class="account-profile">
                        <div class="profile-wrapper">
                            <section class="list-data">
                                ...
                                <div class="content">
                                    <form action="{{ route('account.article.store') }}" class="form-horizontal form-strip" method="post" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        <fieldset>
                                            ...
                                            <div class="form-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug') }}" placeholder="Custom slug for URL friendly">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group {{ $errors->has('tags') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control typeahead" id="tags" name="tags" placeholder="Tag separated by coma" data-role="tagsinput">
            ...
            <textarea class="form-control summernote" name="content" id="content" cols="30"
                      rows="10" placeholder="Write article here">{!! old('content') !!}</textarea>
            ...
            <textarea class="form-control" name="excerpt" id="excerpt" cols="30"
                      rows="2" placeholder="Write an excerpt (optional)">{{ old('excerpt') }}</textarea>
                                            ...
                                            <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="radio radio-inline">
                                                        <input type="radio" name="status" id="published" value="pending" class="css-radio" required checked>
                                                        <label for="published" class="css-label">Published</label>
                                                    </div>
                                                    <div class="radio radio-inline">
                                                        <input type="radio" name="status" id="draft" value="draft" class="css-radio">
