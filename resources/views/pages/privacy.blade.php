    ...
    <section class="container content-wrapper">
        <div class="breadcrumb-wrapper">
            ...
            <div class="control hidden-xs">
                <a class="btn btn-primary control-left" href="editorial.html"><i class="fa fa-chevron-left"></i></a>
                <a class="btn btn-primary control-right" href="disclaimer.html"><i class="fa fa-chevron-right"></i></a>
            </div>
        </div>
        ...
        <div class="row static-page">
            ...
            <div class="col-md-9">
                <article>
                    ...
                    <p>This privacy policy sets out how InfoGue.id uses and protects any information that you give
                        InfoGue.id when you use this website.
                    </p>

                    <p>InfoGue.id is committed to ensuring that your privacy is protected. Should we ask you to provide
                    ...
                    <p>InfoGue.id may change this policy from time to time by updating this page. You should check this page
                    ...
                    <ul>
                        ...
                        <li>if you have previously agreed to us using your personal information for direct marketing
                            purposes, you may change your mind at any time by writing to or emailing us at [email address]
                    ...
                    <p>If you believe that any information we are holding on you is incorrect or incomplete, please write to
