...
<div style="display: block; max-width: 550px; padding: 25px; background: #ffffff; margin: auto; border-top: 3px solid #4dc4d2">
    ...
    <div style="display: block">
        <h2>Hi, {{ $admin->name }}</h2>
        <p style="font-size: 16px; margin-bottom: 0">A contributor create article new article</p>
        <p style="margin-top: 0; margin-bottom: 20px">a little information about the article and contributor</p>
        <div style="display: block; margin-bottom: 30px">
            <div class="info">
                ...
                <p style="margin-top: 0; margin-bottom: 5px">{{ $contributor->location }}</p>
            </div>
        ...
        <div style="margin-bottom: 10px; margin-top: 20px; padding: 8px 15px; background: #f5f5f5;">
            <a href="{{ route('admin.article.index') }}" style="float: left; padding: 10px 15px; font-size: 14px; background: #4dc4d2; text-decoration: none; color: #ffffff; margin: 2px; display: inline-block; vertical-align: middle; font-weight: 600;">APPROVE</a>
            <a href="{{ route('admin.article.index') }}" style="float: left; padding: 10px 15px; font-size: 14px; background: #ac2925; text-decoration: none; color: #ffffff; margin: 2px; display: inline-block; vertical-align: middle; font-weight: 600;">REJECT</a>
            <div style="clear: both"></div>
        </div>
