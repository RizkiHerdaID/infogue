    ...
    <div style="display: block">
        ...
        <div style="display: block; margin-bottom: 50px">
            ...
            <div class="info" style="padding-left: 125px">
                <h3 style="margin-bottom: 0"><a href="{{ route('contributor.stream', [$senderUsername]) }}" style="color: #4dc4d2; text-decoration: none">{{ $senderName }}</a></h3>
                <p style="margin-top: 0; margin-bottom: 5px">{{ $senderLocation }}</p>
                <ul style="list-style: none; margin-bottom: 20px; padding: 0">
                    <li style="display: inline-block; margin-left: 0"><a href="{{ route('contributor.article', [$senderUsername]) }}" style="color: #4dc4d2; text-decoration: none">{{ $senderArticle }} Articles</a> &nbsp;&nbsp; |</li>
                    <li style="display: inline-block;"><a href="{{ route('contributor.follower', [$senderUsername]) }}" style="color: #4dc4d2; text-decoration: none">{{ $senderFollower }} Followers</a> &nbsp;&nbsp; |</li>
                    <li style="display: inline-block;"><a href="{{ route('contributor.following', [$senderUsername]) }}" style="color: #4dc4d2; text-decoration: none">{{ $senderFollowing }} Following</a></li>
                </ul>
            </div>
            <div style="clear: both"></div>
        </div>
        <p style="margin-bottom: 20px; font-size: 16px;">"{{ $receiverMessage }}"</p>
        <p style="margin-bottom: 50px"><a href="{{ route('account.message.conversation', [$senderUsername]) }}" style="padding: 10px 15px; background: #4dc4d2; text-decoration: none; color: #ffffff; margin: 2px; display: inline-block; vertical-align: middle; font-weight: 600;">REPLY THIS MESSAGE</a></p>
        <div style="margin-bottom: 10px; margin-top: 20px; padding: 8px 15px; background: #f5f5f5;">
            <p style="float: left">Checkout your messages page for more</p>
            <a href="{{ route('account.message.list') }}" style="float: right; padding: 10px 15px; font-size: 14px; background: #4dc4d2; text-decoration: none; color: #ffffff; margin: 2px; display: inline-block; vertical-align: middle; font-weight: 600;">SEE ALL MESSAGES</a>
            <div style="clear: both"></div>
        </div>
