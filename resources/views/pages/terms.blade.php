    ...
    <section class="container content-wrapper">
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb mtn">
                ...
                <li class="active">Terms<span class="hidden-xs"> & Conditions</span></li>
                <li class="blank"></li>
            </ol>
            <div class="control hidden-xs">
                <a class="btn btn-primary control-left" href="disclaimer.html"><i class="fa fa-chevron-left"></i></a>
                <a class="btn btn-primary control-right" href="career.html"><i class="fa fa-chevron-right"></i></a>
            </div>
        </div>
            ...
            <div class="col-md-9">
                <article>
                    ...
                    <p>Welcome to our website. If you continue to browse and use this website, you are agreeing to comply
                        ...
                        policy govern InfoGue.id's relationship with you in relation to this website. If you disagree
                        with any part of these terms and conditions, please do not use our website.
                    </p>

                    <p>The term 'InfoGue.id' or 'us' or 'we' refers to the owner of the website whose registered office
                        is Jakarta, Indonesia. Our company registration number is Jakarta, 68265KHIF. The term 'you' refers to the user or viewer of our website.
                    </p>
                    ...
                    <ul>
                        ...
                        <li>This website uses cookies to monitor browsing preferences. If you do allow cookies to be used,
                            the following personal information may be stored by us for use by third parties: Social network
