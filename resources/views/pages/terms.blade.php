    ...
    <section class="container content-wrapper">
        ...
        <div class="breadcrumb-wrapper">
            ...
            <div class="control hidden-xs">
                <a class="btn btn-primary control-left" href="{{ route('page.disclaimer') }}">
                    <i class="fa fa-chevron-left"></i>
                </a>
                <a class="btn btn-primary control-right" href="{{ route('page.career') }}">
            ...
            <div class="col-md-9">
                <article>
                    ...
                    <p>Welcome to our website. If you continue to browse and use this website, you are agreeing to
                        ...
                        privacy policy govern InfoGue.id's relationship with you in relation to this website. If you
                    ...
                    <p>The term 'InfoGue.id' or 'us' or 'we' refers to the owner of the website whose registered office
                        is Jakarta, Indonesia. Our company registration number is Jakarta, 68265KHIF. The term 'you'
                    ...
                    <ul>
                        ...
                        <li>This website uses cookies to monitor browsing preferences. If you do allow cookies to be
                            ...
                            Social network like Facebook, Google+ and Twitter.
                        </li>
                        ...
                        <li>All trade marks reproduced in this website which are not the property of, or licensed to,
