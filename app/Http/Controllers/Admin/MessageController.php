...
class MessageController extends Controller
{
    ...
    */
    ...
    /**
     * Display a listing of the admin message.
     *
    ...
    public function index(Request $request)
    {
        ...
        $messages = $this->message->retrieveMessages(Auth::guard('admin')->user()->id);
    ...
    public function conversation(Request $request, $username)
    {
        ...
        if ((Input::get('page', false) || Input::has('last')) && $request->ajax()) {
            ...
            return view('admin.message.conversation', compact('contributor', 'conversations'));
        }
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $result = DB::transaction(function () use ($request, $message, $id) {
            try {
                ...
                return redirect(route('admin.message.index'))->with([
                    'status' => 'danger',
