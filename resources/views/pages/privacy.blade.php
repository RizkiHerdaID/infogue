    ...
    <section class="container content-wrapper">
        ...
        <div class="breadcrumb-wrapper">
            ...
            <div class="control hidden-xs">
                <a class="btn btn-primary control-left" href="{{ route('page.editorial') }}">
                    <i class="fa fa-chevron-left"></i>
                </a>
                <a class="btn btn-primary control-right" href="{{ route('page.disclaimer') }}">
        ...
        <div class="row static-page">
            ...
            <div class="col-md-9">
                <article>
                    ...
                    <p>InfoGue.id may change this policy from time to time by updating this page. You should check this
                        page from time to time to ensure that you are happy with any changes. This policy is effective
                        from January 2016.
                    </p>
