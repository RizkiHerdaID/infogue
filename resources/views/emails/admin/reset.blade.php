...
<div style="display: block; padding: 20px">
    <div style="margin-bottom: 30px; text-align: center">
        ...
        <h2 style="margin-top: 0; color: #4dc4d2">ADMIN RESET PASSWORD</h2>
    </div>

    <div style="text-align: center">
        <h2>Hi, {{ $name }}</h2>
        <p style="margin-bottom: 5px">We recently received a request to change the password,
            if you don't remember make this request or you think it's a mistake please contact your developer to suspend your account temporarily by clicking link below.</p>
        <a href="mailto:anggadarkprince@gmail.com" style="color: #00aced; text-decoration: none; font-size: 16px">REQUEST TO SUSPEND ACCOUNT</a>
