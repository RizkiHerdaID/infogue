...
<body style="font-family: 'Open Sans', sans-serif; color: #555; margin: 0; padding: 20px;">
...
<div style="display: block;">
    ...
    <div style="display: block">
        <h2>Hi, {!! $name !!}</h2>
        <p style="font-size: 16px; margin-bottom: 0">Thanks for contacting Infogue</p>
        <p style="margin-top: 0; margin-bottom: 30px">recently we receive message from you regarding topic:</p>
        <div style="display: block; margin-bottom: 20px; padding: 20px; background-color: #f5f5f5">
            <h3>YOUR FEEDBACK</h3>
            {!! $feedback !!}
        </div>

        <div style="display: block; margin-bottom: 50px; padding: 20px; background-color: #f5f5f5">
            <h3>INFOGUE SUPPORT</h3>
            <p style="margin-bottom: 20px;">{!! nl2br($reply) !!}</p>
            <p style="margin-bottom: 20px"><a href="{{ url('contact') }}" style="padding: 10px 15px; background: #4dc4d2; text-decoration: none; color: #ffffff; margin: 2px; display: inline-block; vertical-align: middle; font-weight: 600;">REPLY THIS MESSAGE</a></p>
        </div>
        ...
        <div style="text-align: center; font-size: 12px; color: #aaa">
            ...
            <p>
                ...
                Infogue Publisher. This email was intended for {{ $name }}. <a href="{{ url('faq') }}" style="color: #4dc4d2;">Learn why we included this</a>.</p>
