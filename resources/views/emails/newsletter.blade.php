    ...
    <div style="display: block">
        ...
        <div style="text-align: center; font-size: 12px; color: #aaa">
            ...
            <p>
                ...
                Infogue Publisher. <a href="{{ route('subscribe.stop', [$email]) }}" style="color: #4dc4d2;">Unsubscribe</a>
                This email was intended for {{ $email }}. <a href="{{ url('faq') }}" style="color: #4dc4d2;">Learn why we included this</a>.</p>
