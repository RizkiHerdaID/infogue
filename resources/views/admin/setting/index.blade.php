    ...
    <div id="content-wrapper">
        ...
        <div class="content">
            <div class="title-section">
                ...
                <p class="subtitle">Basic web configuration and contact
                    <a href="#" class="pull-right hidden-xs reset-setting">RESET DEFAULT</a>
                </p>
            </div>
                ...
                <form acion="{{ route('admin.setting.update') }}" class="form-horizontal form-strip" id="form-setting" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group {{ $errors->has('website') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="website" name="website"
                                       value="{{ old('website', $site_settings['Website Name']) }}"
                                       placeholder="Put the website name" required maxlength="30">
                        ...
                        <div class="form-group {{ $errors->has('keywords') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="keywords" name="keywords"
                                       value="{{ old('keywords', $site_settings['Keywords']) }}"
                                       placeholder="Separated by coma" data-role="tagsinput" required maxlength="200">
                                <input type="text" class="form-control-dummy" id="keywords_dummy" name="keywords_dummy" />
                            ...
                            <div class="col-sm-9">
                                <div class="radio radio-inline">
                                    <input type="radio" name="status" id="online" value="online"
                                           class="css-radio" @if(old('status', $site_settings['Status']) == 'online') checked @endif required>
                                    <label for="online" class="css-label">Online</label>
                                </div>
                                <div class="radio radio-inline">
                                    <input type="radio" name="status" id="maintenance" value="maintenance"
                                           class="css-radio" @if(old('status', $site_settings['Status']) == 'maintenance') checked @endif>
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="address" id="address" cols="30" rows="2" placeholder="Company address" required maxlength="100">{{ old('address', $site_settings['Address']) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('contact') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="contact" name="contact"
                                       value="{{ old('contact', $site_settings['Contact']) }}"
                                       placeholder="Office phone or Fax" required maxlength="50">
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" id="email" name="email"
                                       ...
                                       placeholder="Company email address" required maxlength="50">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="description" id="description" cols="30" rows="3" placeholder="Describe about this website" required maxlength="160">{{ old('description', $site_settings['Description']) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('owner') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="owner" name="owner"
                                       value="{{ old('owner', $site_settings['Owner']) }}"
                                       placeholder="Company or website owner" maxlength="30">
                        ...
                        <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control mbs" id="latitude" name="latitude"
                                               value="{{ old('latitude', $site_settings['Latitude']) }}"
                                               placeholder="Latitude coordinate" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="longitude" name="longitude"
                                               value="{{ old('longitude', $site_settings['Longitude']) }}"
                                               placeholder="Longitude coordinate" required>
                                    </div>
                                </div>
                        ...
                        <div class="form-group {{ $errors->has('facebook') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="url" class="form-control" id="facebook" name="facebook"
                                       ...
                                       placeholder="Full url of Facebook account" maxlength="200">
                        ...
                        <div class="form-group {{ $errors->has('twitter') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="url" class="form-control" id="twitter" name="twitter"
                                       value="{{ old('twitter', $site_settings['Twitter']) }}"
                                       placeholder="Full url of Twitter account" maxlength="200">
                        ...
                        <div class="form-group {{ $errors->has('googleplus') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="url" class="form-control" id="googleplus" name="googleplus"
                                       value="{{ old('googleplus', $site_settings['Google Plus']) }}"
                                       placeholder="Full url of Google+ account" maxlength="100">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group {{ $errors->has('notification') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox {{ $errors->has('article') ? 'has-error' : '' }}">
                                    <input type="checkbox" name="article" id="article" value="1" class="css-checkbox"
                                           @if(old('article', $site_settings['Email Article'])) checked @endif>
                                ...
                                <div class="checkbox {{ $errors->has('feedback') ? 'has-error' : '' }}">
                                    <input type="checkbox" name="feedback" id="feedback" value="1" class="css-checkbox"
                                           @if(old('feedback', $site_settings['Email Feedback'])) checked @endif>
                                    <label for="feedback" class="css-label">Email me when I got a feedback</label>
                                </div>
                                <div class="checkbox {{ $errors->has('member') ? 'has-error' : '' }}">
                                    <input type="checkbox" name="member" id="member" value="1" class="css-checkbox"
                                           @if(old('member', $site_settings['Email Contributor'])) checked @endif>
                        ...
                        <div class="form-group {{ $errors->has('approve') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <div class="radio radio-inline">
                                    <input type="radio" name="approve" id="yes" value="1" class="css-radio"
                                           @if(old('approve', $site_settings['Auto Approve'])) checked @endif required>
                                    <label for="yes" class="css-label">Yes</label>
                                </div>
                                <div class="radio radio-inline">
                                    <input type="radio" name="approve" id="no" value="0" class="css-radio"
                                           @if(!old('approve', $site_settings['Auto Approve'])) checked @endif required>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group {{ $errors->has('email_admin') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="email_admin" name="email_admin" placeholder="Admin email address"
                                       value="{{ old('email_admin', Auth::guard('admin')->user()->email) }}" required maxlength="30">
                                {!! $errors->first('email_admin', '<span class="help-block">:message</span>') !!}
                            </div>
                        </div>
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Put your name here"
                                       value="{{ old('name', Auth::guard('admin')->user()->name) }}" required maxlength="50">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-lg-3">
                                        <div class="contributor-profile">
                                            <img src="{{ asset('images/contributors/'.Auth::guard('admin')->user()->avatar) }}"
                                                 class="img-circle img-responsive avatar" width="120" height="120"/>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group {{ $errors->has('new_password') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" id="new_password" name="new_password"
                                       placeholder="Create new password" pattern=".{6,20}">
                        ...
                        <div class="form-group {{ $errors->has('new_password_confirmation') ? 'has-error' : '' }}">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" id="new_password_confirmation"
                                       name="new_password_confirmation" placeholder="Retype new password" pattern=".{6,20}">
