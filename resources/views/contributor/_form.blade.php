<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" id="slug" placeholder="Custom slug for URL friendly">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <div class="radio radio-inline">
                <input type="radio" name="format" id="standard" class="css-radio" checked>
...
<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" id="tags" placeholder="Tag separated by coma" data-role="tagsinput">
        </div>
    </div>
</fieldset>
<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <div class="css-file">
                ...
                <input type="file" class="file-input" id="featured" accept="image/*"/>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea class="form-control summernote" name="content" id="content" cols="30"
                      rows="10" placeholder="Write article here"></textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea class="form-control" name="excerpt" id="excerpt" cols="30"
                      rows="2" placeholder="Write an excerpt (optional)"></textarea>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <div class="radio radio-inline">
                <input type="radio" name="status" id="published" class="css-radio" checked>
            ...
            <span class="help-block"><i class="fa fa-info-circle mrs mts"></i>Wait administrator confirmation.</span>
        </div>
    </div>
    <div class="form-group no-line">
        <div class="col-sm-offset-3 col-sm-9 pts pbm">
            <button class="btn btn-primary">CREATE ARTICLE</button>
            <a href="contributor_article.html" class="btn btn-danger">DISCARD</a>
        </div>
    </div>
</fieldset>